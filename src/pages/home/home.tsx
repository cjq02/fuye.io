    ...
    <div className="page-container home-container">
      ...
      <div className="logo-section">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-gray-600 mt-2 animate-text-3">向Telegram致敬 但富业<a href={APP_URL} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 ml-1 mr-1">fuye.io</a>更适合做业务</p>
        </div>
      </div>
